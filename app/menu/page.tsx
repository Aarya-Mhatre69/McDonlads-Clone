...
// ISR — regenerate every hour; change to 0 for fully dynamic SSR
export const revalidate = 3600;

export const metadata: Metadata = {
  title: "Full Menu | McDonald's India — Burgers, Wraps & More",
  description:
    "Browse 50+ authentic Indian fusion menu items — McAloo Tikki, McSpicy Paneer, Chicken Maharaja Mac, Masala Fries and more. Veg, Non-Veg and Jain options.",
  keywords: "McDonald's India menu, McAloo Tikki, McSpicy Paneer, Maharaja Mac, Jain burger, veg burger India",
  openGraph: {
    title:       "McDonald's India — Full Menu",
    description: "Explore India's most-loved McDonald's fusion menu.",
    type:        "website",
  },
};

// Server Component — HTML rendered on the server, initialItems serialised into the page
export default function MenuPage() {
  const items = MENU_ITEMS; // swap for a DB call once you seed MongoDB
  ...
  return (
    <div id="menu-page-root" style={{ minHeight: "100vh", background: "#FAFAFA", fontFamily: "'Outfit',sans-serif" }}>
      ...
      <header style={{ background: "#fff", borderBottom: "3px solid #FFC72C", padding: "64px 64px 44px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ color: "#888", fontSize: 15, maxWidth: 480, lineHeight: 1.7, marginBottom: 32, fontFamily: "'Outfit',sans-serif" }}>
            Authentic Indian flavours meet McDonald&apos;s magic — {items.length}+ items crafted for your taste buds.
          </p>

          <nav aria-label="Menu categories" style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {[
      ...
      {/* ══ MENU CONTENT — client component handles all interactivity ══ */}
      <main id="main-content" style={{ maxWidth: 1280, margin: "0 auto", padding: "36px 64px 80px" }}>
